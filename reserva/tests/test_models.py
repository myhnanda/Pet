...
def test_reserva_deve_retornar_string_formatada(reserva): 
    assert str(reserva) == 'Tom: 2024-03-08 (Tarde)' # vc precisa alterar a data de acordo com o dia atual do seu computador
...
def test_nota_invalida():
    ...
    avaliacao = Avaliacao(petshop = petshop, nota = 10, comentario="A nota deve ser no máximo 10")
    avaliacao.full_clean()
